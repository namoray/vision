...
SPECIAL_CONCEPTS = ["little girl", "young child", "young girl", "little boy", "young boy"]
NSFW_CONCEPTS = [
    "sexual",
    "nude",
    "sex",
...
PROVIDER_INT_TO_NAME = {
    1: GO_API_PROVIDER,
    2: IMAGINE_SLASH_PROVIDER
}
...
KANDINSKY_2_2_DECODER_INPAINT_MODEL_ID = "kandinsky-community/kandinsky-2-2-decoder-inpaint"
...
SOTA_PROVIDER_PARAM = "SOTA_PROVIDER_PARAM"
SOTA_KEY_PARAM = "sota_key_param"
...
CHECKING_SERVER_ADDRESS_PARAM = 'CHECKING_SERVER_ADDRESS'
SAFETY_CHECKER_SERVER_ADDRESS_PARAM = 'SAFETY_CHECKER_SERVER_ADDRESS'
